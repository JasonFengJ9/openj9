...
//	printf("processAgentLibraryFromArgsList() agentIndex (%zd) \n", agentIndex);
	while (agentIndex >= 0) {
		J9JVMTIAgentLibrary *agentLibrary = NULL;
		if (JNI_OK != createAgentLibraryWithOption(vm, argsList, agentIndex, &agentLibrary)) {
//			printf("processAgentLibraryFromArgsList() createAgentLibraryWithOption() failed \n");
			result = FALSE;
			break;
		}
#if defined(J9VM_OPT_CRIU_SUPPORT)
...
//				printf("processAgentLibraryFromArgsList() loadAgentLibrary() failed \n");
				result = FALSE;
				break;
			}
//			printf("processAgentLibraryFromArgsList() jdwpEnabled = TRUE \n");
			jdwpEnabled = TRUE;
		}
#endif /* defined(J9VM_OPT_CRIU_SUPPORT) */
...
#if defined(J9VM_OPT_CRIU_SUPPORT)
	if (jdwpEnabled) {
//		printf("processAgentLibraryFromArgsList J9VM_CRIU_IS_JDWP_ENABLED \n ");
...
//	printf("criuRestoreInitializeLib started.. \n");
	...
	if (J9_ARE_NO_BITS_SET(vm->checkpointState.flags, J9VM_CRIU_IS_JDWP_ENABLED)) {
		...
		if (NULL != jvmtiData) {
//			printf("criuDisableHooks started.. \n");
