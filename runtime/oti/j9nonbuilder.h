...
#if defined(J9VM_OPT_JFR)
/* This has to match jdk.jfr.internal.LogLevel. */
typedef enum JFRLogLevel {
	JFRLOGLEVEL_INVALID = 0,
	JFRLOGLEVEL_TRACE   = 1,
	JFRLOGLEVEL_DEBUG   = 2,
	JFRLOGLEVEL_INFO    = 3,
	JFRLOGLEVEL_WARN    = 4,
...
typedef enum JFRLogTagCombination {
	COMBINATION_JFR                     = TAG_JFR,                              /* 0 */
	COMBINATION_JFR_SYSTEM              = TAG_JFR | TAG_SYSTEM,                 /* 1 */
	COMBINATION_JFR_SYSTEM_EVENT        = TAG_JFR | TAG_SYSTEM | TAG_EVENT,     /* 2 */
	COMBINATION_JFR_SYSTEM_SETTING      = TAG_JFR | TAG_SYSTEM | TAG_SETTING,   /* 3 */
	COMBINATION_JFR_SYSTEM_BYTECODE     = TAG_JFR | TAG_SYSTEM | TAG_BYTECODE,  /* 4 */
	COMBINATION_JFR_SYSTEM_PARSER       = TAG_JFR | TAG_SYSTEM | TAG_PARSER,    /* 5 */
	COMBINATION_JFR_SYSTEM_METADATA     = TAG_JFR | TAG_SYSTEM | TAG_METADATA,  /* 6 */
	COMBINATION_JFR_SYSTEM_STREAMING    = TAG_JFR | TAG_SYSTEM | TAG_STREAMING, /* 7 */
	COMBINATION_JFR_SYSTEM_THROTTLE     = TAG_JFR | TAG_SYSTEM | TAG_THROTTLE,  /* 8 */
	COMBINATION_JFR_METADATA            = TAG_JFR | TAG_METADATA,               /* 9 */
	COMBINATION_JFR_EVENT               = TAG_JFR | TAG_EVENT,                  /* 10 */
	COMBINATION_JFR_SETTING             = TAG_JFR | TAG_SETTING,                /* 11 */
	COMBINATION_JFR_DCMD                = TAG_JFR | TAG_DCMD,                   /* 12 */
	COMBINATION_JFR_START               = TAG_JFR | TAG_START,                  /* 13 */
	/* The total number of valid combinations from COMBINATION_JFR to COMBINATION_JFR_START. */
	COMBINATION_JFRTAG_COUNT            = 14,                                   /* 14 */
	COMBINATION_JFRTAG_INVAID           = -1                                    /* invalid JFR tag */
