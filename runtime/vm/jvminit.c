...
convertTagName(const char *jfrLogTag)
{
	...
	if (0 == j9_cmdla_stricmp(jfrLogTag, "jfr")) {
		tag = TAG_JFR;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "system")) {
		tag = TAG_SYSTEM;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "event")) {
		tag = TAG_EVENT;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "setting")) {
		tag = TAG_SETTING;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "bytecode")) {
		tag = TAG_BYTECODE;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "parser")) {
		tag = TAG_PARSER;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "metadata")) {
		tag = TAG_METADATA;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "streaming")) {
		tag = TAG_STREAMING;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "throttle")) {
		tag = TAG_THROTTLE;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "dcmd")) {
		tag = TAG_DCMD;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, "start")) {
		tag = TAG_START;
	}
