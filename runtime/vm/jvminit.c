...
convertLogLevel(const char *jfrLogLevel)
{
	...
	if (0 == j9_cmdla_stricmp(jfrLogLevel, "trace")) {
		logLevel = JFRLOGLEVEL_TRACE;
	} else if (0 == j9_cmdla_stricmp(jfrLogLevel, "debug")) {
		logLevel = JFRLOGLEVEL_DEBUG;
	} else if (0 == j9_cmdla_stricmp(jfrLogLevel, "info")) {
		logLevel = JFRLOGLEVEL_INFO;
	} else if (0 == j9_cmdla_stricmp(jfrLogLevel, "warn")) {
		logLevel = JFRLOGLEVEL_WARN;
	} else if (0 == j9_cmdla_stricmp(jfrLogLevel, "error")) {
...
convertTagName(const char *jfrLogTag)
{
	...
	if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_JFR)) {
		tag = TAG_JFR;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_SYSTEM)) {
		tag = TAG_SYSTEM;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_EVENT)) {
		tag = TAG_EVENT;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_SETTING)) {
		tag = TAG_SETTING;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_BYTECODE)) {
		tag = TAG_BYTECODE;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_PARSER)) {
		tag = TAG_PARSER;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_METADATA)) {
		tag = TAG_METADATA;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_STREAMING)) {
		tag = TAG_STREAMING;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_THROTTLE)) {
		tag = TAG_THROTTLE;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_DCMD)) {
		tag = TAG_DCMD;
	} else if (0 == j9_cmdla_stricmp(jfrLogTag, JFRLOGTAG_START)) {
		tag = TAG_START;
	}
